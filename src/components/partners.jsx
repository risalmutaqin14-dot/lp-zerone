  ...
  return (
    <section className="about-section">
      <div className="about-container">
        <h2 className="about-title">Be Recognized Be Different</h2>
        <p className="font-light text-[25px] leading-7">
          There're a lot of product same as you. How can the customer select your <br className="hidden md:inline" />product instead? You need apply a special and attractive way!
        </p>
        ...
        <div className="partners-carousel partners-carousel--second" aria-hidden="false">
          <div className="carousel-viewport">
            <div className="carousel-track swiper-wrapper reverse" role="list">
              {duplicatedImages2.map((image, index) => (
                <div className="carousel-item" key={`r-${index}`} role="listitem">
                  <img className="carousel-image" src={image.src} alt={image.alt} />
                </div>
              ))}
            </div>
