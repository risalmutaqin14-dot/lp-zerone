    ...
    <>
      <div className="webApp pt-16 lg:pt-5 bg-white">
        <Helmet>
          ...
          <meta
            name="description"
            content="Zerone Global provides Mobile App Development services for Android & iOS. Our digital solutions help businesses build scalable, secure applications ready to compete in the global market."
          />
          <meta name="robots" content="index, follow" />
          <link rel="canonical" href="https://www.zerone.id/mobile-app" />
          <meta
            property="og:title"
            content="Mobile App Development | Zerone Global Digital Solution"
          />
          <meta
            property="og:description"
            content="Zerone Global Mobile App solutions help businesses build scalable, secure Android & iOS applications ready for the global market."
          />
        ...
        <div className="container mx-auto pt-[80px] lg:px-32 px-5 lg:mt-20 grid grid-cols-1 gap-4 lg:grid-cols-2">
          ...
          <div>
            <img
              ...
              className="hidden lg:block w-full max-w-[500px] pt-10 lg:pt-0 lg:pl-32 md:pl-20 relative lg:left-[-80px] left-[-2px]"
            />
          </div>
        </div>
        ...
        <section className="features-section container mx-auto lg:px-32 bg-white">
          <div className="pb-20 grid grid-cols-1 gap-6 sm:grid-cols-3 lg:grid-cols-3">
            <img
              ...
              alt="Latihan.id Mobile Learning App Interface - Zerone Global Portfolio"
            />
            <img
              src={solutionAppDev.appDev2}
              className="shadow-lg rounded-[11px] transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer"
              alt="Venti.id Mobile Application Design - Zerone Global Portfolio"
            />
            <img
              src={solutionAppDev.appDev3}
              className="shadow-lg rounded-[11px] transition-all duration-300 hover:scale-105 hover:shadow-2xl cursor-pointer"
              alt="Rajin.id Employee Management Mobile App - Zerone Global Portfolio"
            />
          </div>
        </section>
      </div>
