...
// Asumsi: Anda mengimpor data blog dari lokasi yang sama dengan komponen Blog
...
function PostDetail() {
  ...
  useEffect(() => {
    // Cari postingan berdasarkan ID (konversi ID dari string URL ke tipe yang sesuai,
    // dalam kasus ini saya asumsikan ID di data adalah angka, jadi kita konversi ke Number)
  ...
  // Jika postingan ditemukan, tampilkan detailnya
  return (
